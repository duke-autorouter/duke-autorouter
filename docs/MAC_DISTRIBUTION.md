...
The [0.1.4 release](https://github.com/duke-autorouter/duke-autorouter/releases/tag/v0.1.4)
includes a DMG, ZIP, checksums and release manifest. The
[distribution receipt](evidence/distribution-0.1.4-verification.json) identifies the
