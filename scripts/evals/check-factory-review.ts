...
import { probes } from '../../evals/factory-cycle-2/fixtures.js';
...
const receipt:any={scope:'Fresh Jev-only review probes; no worker or efficiency claim',sourceCommit:execFileSync('git',['rev-parse','HEAD'],{encoding:'utf8'}).trim(),fixtureSHA256:sha(JSON.stringify(probes)),startedAt:new Date().toISOString(),results:[]};
